      ...
      <main className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <Card className="bg-white">
            <CardContent className="p-5">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="text-gray-500 text-sm">Eficiência do Sistema</h3>
                  <p className="text-3xl font-bold text-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
          ...
          <Card className="col-span-1 lg:col-span-3 bg-white">
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="text-lg font-bold text-gray-800">Consumo Diário</CardTitle>
          ...
          <Card className="col-span-1 lg:col-span-2 bg-white">
            <CardHeader>
              <CardTitle className="text-lg font-bold text-gray-800">Distribuição de Consumo</CardTitle>
            </CardHeader>
            <CardContent>
              <DonutChart />
            </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <Card className="bg-white">
            <CardContent className="p-6">
              <h3 className="font-bold text-gray-800 mb-4">Qualidade da Água</h3>

              <div className="flex justify-between space-x-4 mb-6">
                <div className="bg-gray-50 rounded-xl p-3 text-center w-1/3">
                  <div className="text-3xl font-bold text-primary mb-1">7.2</div>
                  <div className="text-xs text-gray-500">pH</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-3 text-center w-1/3">
                  <div className="text-3xl font-bold text-primary mb-1">0.8</div>
                  <div className="text-xs text-gray-500">Cloro (mg/L)</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-3 text-center w-1/3">
                  <div className="text-3xl font-bold text-primary mb-1">2.1</div>
              ...
              <div className="flex items-center bg-success/10 rounded-lg p-3">
                ...
                <div>
                  <p className="text-gray-800 text-sm font-medium">Dentro dos Padrões</p>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start p-3 bg-primary-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm text-gray-800">Manutenção Preventiva</p>
                    <p className="text-xs text-gray-500">Agendada para 15/07 - 08:00</p>
                  </div>
                </div>

                <div className="flex items-start p-3 bg-warning/10 rounded-lg">
                  <span className="material-symbols-outlined text-warning mr-3">water_damage</span>
                  <div>
                    <p className="text-sm text-gray-800">Consumo Acima da Média</p>
                    <p className="text-xs text-gray-500">Setor B2 - Ontem às 22:15</p>
                  </div>
                </div>

                <div className="flex items-start p-3 bg-success/10 rounded-lg">
                  <span className="material-symbols-outlined text-success mr-3">task_alt</span>
                  <div>
                    <p className="text-sm text-gray-800">Troca de Filtros Concluída</p>
                    <p className="text-xs text-gray-500">Hoje às 09:45</p>
                  </div>
                </div>
              </div>

              <Button variant="outline" className="w-full mt-4 py-2 rounded-lg text-primary text-sm">
        ...
        <Card className="w-full bg-white">
          <CardContent className="p-6">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-bold text-gray-800">Estações de Tratamento</h3>
              <div className="flex space-x-2">
              ...
              <table className="w-full border-separate border-spacing-y-2">
                ...
                <tbody>
                  <tr className="bg-gray-50 hover:bg-gray-100 transition-colors">
                    <td className="py-3 pl-4 rounded-l-lg text-gray-600">#EST-001</td>
                    <td className="py-3">
                    ...
                    <td className="py-3 rounded-r-lg">
                      <div className="flex justify-end space-x-1">
                        ...
                        <Button
                          ...
                          className="p-1.5 rounded-lg hover:bg-gray-200 transition-colors"
                        >
                          <span className="material-symbols-outlined text-sm text-gray-600">more_horiz</span>
                        </Button>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr className="bg-gray-50 hover:bg-gray-100 transition-colors">
                    <td className="py-3 pl-4 rounded-l-lg text-gray-600">#EST-002</td>
                    <td className="py-3">
                      <div className="flex items-center">
                        <div className="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center mr-3">
                          <span className="material-symbols-outlined text-sm text-primary">water_drop</span>
                    ...
                    <td className="py-3">
                      <div className="flex items-center">
                        <div className="h-1.5 w-24 bg-gray-200 rounded-full overflow-hidden mr-2">
                          <div className="h-full progress-bar-gradient rounded-full" style={{ width: "88%" }}></div>
                        </div>
                  ...
                  <tr className="bg-gray-50 hover:bg-gray-100 transition-colors">
                    <td className="py-3 pl-4 rounded-l-lg text-gray-600">#EST-003</td>
                    <td className="py-3">
                      <div className="flex items-center">
                        <div className="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center mr-3">
                          <span className="material-symbols-outlined text-sm text-primary">water_drop</span>
                    ...
                    <td className="py-3">
                      <div className="flex items-center">
                        <div className="h-1.5 w-24 bg-gray-200 rounded-full overflow-hidden mr-2">
                          <div className="h-full progress-bar-gradient rounded-full" style={{ width: "0%" }}></div>
                        </div>
